...
class ProInfoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('resumeFILE', FileType::class, [ 
            ...
            'mapped' => false,
            'required' => false,
            'attr'=>array('class'=>'form-control mb-3 form-control-lg form-control-solid','placeholder'=>'', 'accept'=>'images/*' ),
            'constraints' => [ 
                new File([
